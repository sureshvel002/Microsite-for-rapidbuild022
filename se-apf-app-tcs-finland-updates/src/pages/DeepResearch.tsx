...
const DeepResearch = () => {
  ...
  const PDF_URL = "/documents/jj-deep-research-document.pdf";

  const handleDownload = () => {
    const link = document.createElement("a");
    link.href = PDF_URL;
    link.download = "J&J Deep Research Document.pdf";
    link.click();
  };
      ...
      <header className="border-b border-border bg-card px-4 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold font-display text-card-foreground">J&amp;J Deep Research Document</h1>
          </div>
      ...
      <div className="flex-1 p-4">
        <div className="max-w-5xl mx-auto h-[calc(100vh-100px)] bg-card rounded-xl border border-border shadow-sm overflow-hidden">
          <iframe
            ...
            title="J&J Deep Research Document"
          />
        </div>
      </div>
    </div>
